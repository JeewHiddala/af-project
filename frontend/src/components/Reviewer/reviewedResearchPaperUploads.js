...
class ReviewedResearchPaperUpload extends Component {
  constructor(props) {
    super(props);
        ...
        //this.onWorkshopIdSelect = this.onWorkshopIdSelect.bind(this);
    ...
    axios.get(`http://localhost:7000/researchPaper/${data}`)
    .then(response => {
      ...
      /*onWorkshopIdSelect(e){
        this.setState({ selectedWorkshopProposals: e ? e.map(item => item.value) : [] });
      }*/
      ...
      onSubmit(e) {
        ...
        console.log("userid: "+data);
        let reviewedResearchPaperUpload = {
          researchPaperlId: data,
        ...
        console.log('DATA TO SEND', reviewedResearchPaperUpload)
        Swal.fire({
          title: 'Are you sure?',
        ...
        axios.post('http://localhost:7000/reviewedResearchPaperUpload/create', reviewedResearchPaperUpload)
              //axios.patch(`http://localhost:7000/workshopProposal/${workshopProposalId}`)
        .then((response) => {
                ...
                <form onSubmit={this.onSubmit} onChange={this.onHandle}>
                    ...
                    <div className={"row"}>
                        ...
                        <div className="mb-3" style={{textAlign:"left"}}>
                                <label htmlFor="title"  className="form-label">Research Paper Title</label>
                                <input
                                    type="text"
...
export default ReviewedResearchPaperUpload;
